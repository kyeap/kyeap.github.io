...
export const projectsData = [
  {
    ...
    title: 'Ilios App',
    info: 'Backend developer for an ecommerce App for individual buyers, retailers and resellers using laravel.',
    point: {
  ...
  },
  {
    ...
    img: 'twine.jpg',
    title: 'Twine App',
    info: 'Fullstack React Native developer for an app that allows volunteers, volunteers admin and organisation owners of Charitable organisation to better keep track of their projects and activities ',
    point: {
  ...
  },
  {
    ...
    img: 'bemyownboss.png',
    title: 'Bemyownboss',
    info: 'Fullstack developer for marketing one page website that uses the sales funnel strategy to collect contact and generate leads.',
    point: {
      one: 'Developed the frontend and backend for the various customer using CSS, HTML, JavaScript and PHP',
  ...
  },
  {
    ...
    info: 'Build a custome content management system for a insurance agent to manage customer data, insurance policy and renewal.',
    point: {
  ...
  },
  {
    ...
    img: 'mywedding.png',
    title: 'Wedding Site',
    info: 'Fullstack developer for a wedding website to manage RSVP, registration check list and information.',
    point: {
