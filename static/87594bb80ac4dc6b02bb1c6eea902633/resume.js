                            ...
                            {/* <div className="container-resume-circle-footer-block"> */}
                                ...
                                <div className="resume-circle-footer-link">
                                    <a href="www.linkedin.com/in/kenjoo-yeap/">
                                        { window.innerWidth > 374 && <FaLinkedin/> username: kenjoo-yeap}
                                        { !window.innerWidth > 374 && <FaLinkedin/> kenjoo-yeap}
                                    </a>    
                                </div>
                                <div className="resume-circle-footer-link">
                                    <a href="https://github.com/kyeap"> 
                                        { window.innerWidth > 374 && <FaGithub/> username: kyeap}
                                        { !window.innerWidth > 374 && <FaGithub/> kyeap}
                                    </a>
                                </div>
                            {/* </div> */}
                        </div>
